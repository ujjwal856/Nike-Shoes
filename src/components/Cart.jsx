          ...
          {cartItems?.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
            ...
            <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
              <div className="flex items-center justify-between">
                ...
                <h1 className="text-sm rounded bg-theme-cart text-slate-100 px-1 py-0.5">INR {totalAmount}</h1>
              </div>
              <div className="grid items-center gap-2">
                <p className="text-sm font-medium text-center">Taxes and Shipping Will Calculate At Shipping</p>
                <button type="button" className="button-theme bg-theme-cart text-white"><a href="https://buy.stripe.com/test_14k9DO4j8aeSdPieUV">Check Out</a></button>
              </div>
            </div>
